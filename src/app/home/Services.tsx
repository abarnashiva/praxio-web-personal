          ...
          <FlexBox>
              ...
              <Card
                ...
                content={
                  <Paragraph>
                    ...
                    unique solutions to their challenges. It combines
                    engineering expertise with creativity and problem-solving to
                    create tailored hardware solutions.
                  </Paragraph>
                }
              />
            </Link>
            ...
            <Link href="/services/testing-quality">
              <Card
                ...
                content={
                  <Paragraph>
                    They ensure that software products meet the highest
                    standards of performance, reliability, and user
                    satisfaction. Testing involves systematically evaluating
                    software to identify defects or issues, while QA focuses on
                    establishing and standards to deliver a quality product.
                  </Paragraph>
                }
              />
            </Link>
